...
//	$form=str_replace("{seo_reports_range}",$seo_reports->showSeoReports(),$form);
	...
	if ($w=="download") {
//		$seo_reports->exportSeoReportsExcel($date_start,$date_end,$managers,$cash_id,$client_status);
	}
