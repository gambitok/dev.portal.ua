...
if (file_exists("event/".$file.".php")){ include 'event/'.$file.'.php'; }
else{ include 'event/main_page.php'; }
...
$mf3="catalogue"; 				list($accss3,$acc_lvl)=$access->check_user_access($mf3);
$mf4="suppliers_cooperation"; 	list($accss4,$acc_lvl)=$access->check_user_access($mf4);

if ($accss1=="0"){ $content=str_replace("{style_overdraft}", "display:none;", $content); }
if ($accss2=="0"){ $content=str_replace("{style_retail}", "display:none;", $content); }
if ($accss3=="0"){ $content=str_replace("{style_dp}", "display:none;", $content); }
if ($accss4=="0"){ $content=str_replace("{style_cooperation}", "display:none;", $content); }
