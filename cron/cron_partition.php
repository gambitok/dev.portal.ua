...
for ($i=1;$i<=$n;$i++){
	...
	$db->query("INSERT INTO `T2_ARTICLES_PARTITIONS_PERIOD` (`month`,`art_id`,`op_type`,`parrent_type_id`,`parrent_doc_id`,`amount`,`rest`,`price`,`oper_price`,`price_buh_uah`,`price_man_uah`) 
	VALUES ('$month','$art_id','$op_type','$parrent_type_id','$parrent_doc_id','$amount','$rest','$price','$oper_price','$price_buh_uah','$price_man_uah');");
}
