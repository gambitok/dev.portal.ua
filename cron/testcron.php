...
function getClientBalansPeriodEnd($client_id,$cash_id,$saldo_start,$data_from,$data_to){$db=DbSingleton::getDb();session_start();
$saldo_data_start=$data_from; $saldo_data_end=$data_to; $saldo_end=0;
