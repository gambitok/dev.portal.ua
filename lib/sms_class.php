...
function ShowSMSForm(){
	$form_htm=RD."/tpl/sms_form.htm";if (file_exists("$form_htm")){ $form = file_get_contents($form_htm);}
	return $form;
}
function ShowSMSMailerForm(){
	$form_htm=RD."/tpl/sms_mailer_form.htm";if (file_exists("$form_htm")){ $form = file_get_contents($form_htm);}
