...
class suppl_orders{
    ...
    function show_suppl_orders_list(){$db=DbSingleton::getDb();$where="";$limit ="limit 0,300"; if ($where!=""){$limit="";}
    ...
    function showSupplOrder($so_id){$db=DbSingleton::getDb();$cat=new catalogue;$gmanual=new gmanual;
    ...
    function saveSupplOrder($so_id,$amount_order,$delivery_data_finish,$delivery_time_finish,$delivery_type_id,$suppl_order_status_id,$suppl_order_doc){$db=DbSingleton::getDb();$slave=new slave;$answer=0;$err="Помилка збереження даних!";
