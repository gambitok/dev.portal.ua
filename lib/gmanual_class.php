...
class gmanual {
	...
	function show_key_list(){	$db=DbSingleton::getDb();$slave=new slave;$mdl=new module;$url=$mdl->get_file_url("Gmanual");session_start();
		...
		if ($n>0){
			for ($i=1;$i<=$n;$i++){
				...
				$op_btn="<a href='$url/edit/$id' class='btn btn-default btn-round' title='������������� �������'><i class='fa fa-edit'></i></a> 
				<!--<a href='$url/drop/$id' class='btn btn-default btn-round' title='�������� �������'><i class='fa fa-trash'></i></a>-->";
				$view_btn="<a href='$url/view/$gkey' class='btn btn-default btn-round' title='����������� �������'><i class='fa fa-folder-open'></i></a>";
		...
		if ($n==0){
			$list="<tr><td colspan=12 align='center'><h2>���������� ��� �������� �� ��������</h2></td></tr>";
		}
		...
		$new_btn="<a href='$url/new' class='btn btn-success btn-round' title='����� �������'><i class='fa fa-plus'></i></a>";
	...
	function show_gmanual_list($key){$db=DbSingleton::getDb();$slave=new slave;$mdl=new module;$url=$mdl->get_file_url("Gmanual");session_start();
		...
		for ($i=1;$i<=$n;$i++){
			...
			$op_btn="<a href='#editItem' data-toggle=\"modal\" data-target=\".ItemModal\" onclick='setModalFormData(\"$id\",\"$caption\")' class='btn btn-default btn-round' title='������ ��������'><i class='fa fa-edit'></i></a> 
				<!--<a href='$url/drop/$id' class='btn btn-default btn-round' title='�������� �������'><i class='fa fa-trash'></i></a>-->";
			$list.="
				<tr>
					<td align='center'>$i</td>
		...
		if ($list==""){$list="<tr><td align='center' colspan='12'><h2>������� �������</h2></td></tr>";}
	...
	function sendGmanualRequest1($gkey,$id,$caption){$db=DbSingleton::getDb();$slave=new slave;$mdl=new module;$url=$mdl->get_file_url("Gmanual");session_start();$label="info";
		if ($caption==""){$label="error"; $message="�� ��������� ���� ����� �����";}
	...
	function showGmanualList($key,$scaption){$db=DbSingleton::getDb();$slave=new slave; 
		...
		if ($list==""){$list="<tr><td align='center' colspan=2><h2>���������� �������</h2></td></tr>";}
		$form=str_replace("{list}",$list,$form);
		return $form;
	}
	...
	function show_navigation($item_id,$nav_menu){ $mdl=new module;$url=$mdl->get_file_url("gmanual");$nav_menu="<a class='navigation' href='?$url'>�����������</a>";return $nav_menu;}
	function show_menu($w){$slave=new slave; $mdl=new module; $url=$mdl->get_file_url("gmanual");
		$menu="
		<div class='sideMenu' onclick='location.href=\"?$url\";'>��������� �����</div><br />
		<div class='sideMenu' onclick='location.href=\"?$url&w=new_gmanual\";'>���� ��������</div><br />
		";
		return $menu;
	}
