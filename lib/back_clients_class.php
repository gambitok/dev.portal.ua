...
//function setBackClients() {$db=DbSingleton::getDb();
...
function get_back_clients_prefix($back_id){ $db=DbSingleton::getDb();$prefix="��";
...
function get_df_doc_nom_new($sale_invoice_id){ $db=DbSingleton::getDb();$doc_nom=0;
...
//function setSaleInvoiceData(){$db=DbSingleton::getDb();
//	$r=$db->query("select * from J_BACK_CLIENTS;"); $n=$db->num_rows($r); 
// 	for ($i=1;$i<=$n;$i++){
//		$id=$db->result($r,$i-1,"id");									 
//		$sale_invoice_id=$db->result($r,$i-1,"sale_invoice_id");
...
function showBackClientsCard($back_id){$db=DbSingleton::getDb();$slave=new slave;$manual=new manual; $gmanual=new gmanual; session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];
	...
	if ($n==1){ $this->updateBackClientsSumm($back_id);
		...
		if ($user_id!=$user_use && $user_use>0){
			...
			$admin_unlock="";
			if ($user_id==1 || $user_id==2){$admin_unlock="<button class='btn btn-sm btn-warning' onClick='unlockBackClientsCard(\"$back_id\");'><i class='fa fa-unlock'></i> ������������</button>";}
...
function setBackClientsClient($back_id,$client_id){$db=DbSingleton::getDb();$slave=new slave;$answer=0;$err="������� ���������� �����!";$client_name="";
...
function unlinkBackClientsClient($back_id){$db=DbSingleton::getDb();$slave=new slave;$answer=0;$err="������� ���������� �����!";
	$back_id=$slave->qq($back_id);
	if ($back_id>0){
...
function setBackClientsSaleInvoice($back_id,$si_id,$cash_id,$seller_id){$db=DbSingleton::getDb();$slave=new slave;$answer=0;$err="������� ���������� �����!";
...
function unlinkBackClientsTpoint($back_id){$db=DbSingleton::getDb();$slave=new slave;$answer=0;$err="������� ���������� �����!";
	$back_id=$slave->qq($back_id);
	if ($back_id>0){
...
function saveBackClientsCard($back_id,$data_pay,$cash_id,$back_clients_summ,$doc_type_id,$tpoint_id,$client_id,$client_conto_id,$delivery_type_id,$carrier_id,$delivery_address){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function saveBackClientsCardData($back_id,$cash_id,$frm,$tto,$idStr,$artIdStr,$article_nr_displStr,$brandIdStr,$amountStr,$priceStr,$priceEndStr,$discountStr,$summStr){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function setArticleToBackClients($back_id,$si_id,$sis_id,$art_id,$article_nr_displ,$amount_back){$db=DbSingleton::getDb();$dbt=DbSingleton::getTokoDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
	...
	if ($back_id>0 && $si_id>0 && $sis_id>0){
		...
		if ($max_back<$amount_back){$answer=0;$err="ʳ������ ��� ���������� ��� ����� �� �������! (�����������: $max_back)";}
...
function getBackClientsClientContoCash($client_id){$db=DbSingleton::getDb();$cash_id=1;$answer=0;$err="�������";
...
function getBackClientsClientDocType($client_id){$db=DbSingleton::getDb();$doc_type_id=64;$answer=0;$err="�������";
...
function changeBackClientsCash($back_id,$cash_id){$db=DbSingleton::getDb();$dbt=DbSingleton::getTokoDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function dropBackClientsStr($back_id,$back_str_id){$db=DbSingleton::getDb();$dbt=DbSingleton::getTokoDb();$slave=new slave;$answer=0;$err="������� �������";
...
function setBackClientsTpointStorage($back_id,$tpoint_id,$storage_id){$db=DbSingleton::getDb();$answer="�������!";
	$r=$db->query("update J_BACK_CLIENTS set tpoint_id='$tpoint_id', storage_id='$storage_id' where id='$back_id' limit 1;");
	$answer="";
	return $answer;	
}
	
function setBackClientsStorageCell($back_id,$cell_id){$db=DbSingleton::getDb();$answer="�������!";
	$r=$db->query("update J_BACK_CLIENTS set cell_id='$cell_id' where id='$back_id' limit 1;");
	$answer="";
	return $answer;	
}
	
function showStorageSelectListByTpoint($tpoint_id,$sel_id){$db=DbSingleton::getTokoDb();$list="<option value=0>������ � ������</option>";
...
function saveBackClientsStorage($back_id,$storage_id,$storage_cells_id){$db=DbSingleton::getDb();$slave=new slave;session_start();$media_user_id=$_SESSION["media_user_id"];$media_user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function saveBackClientsComment($back_id,$comment){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function dropBackClientsComment($back_id,$comment_id){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ��������� ������!";
...
function BackClientsCDNDropFile($back_id,$file_id){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ��������� �����!";
...
//function setBackPartitions() {$db=DbSingleton::getDb();
...
function acceptBackClients($back_id){$db=DbSingleton::getDb();$dbt=DbSingleton::getTokoDb();$slave=new slave; $cat=new catalogue; session_start(); $user_id=$_SESSION["media_user_id"]; $user_name=$_SESSION["user_name"]; $answer=0;$err="������� ������� �����!"; $data_now=date("Y-m-d");
	$back_id=$slave->qq($back_id);
	if ($back_id>0){
...
function findTaxBySaleInvoiceId($sale_invoice_id){$db=DbSingleton::getDb(); $tax_id=0; //������� ����� �� tax_type_id=160, �.�. �� ����� ��������-������
...
function createBackClientsTax($back_id){$db=DbSingleton::getDb();$cat=new catalogue;$slave=new slave;$manual=new manual;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"]; $gmanual=new gmanual; $cat=new catalogue;
	$answer=0;$err="�������";
...
function printBackClientsN1($back_id){$db=DbSingleton::getDb();$cat=new catalogue;$slave=new slave;$manual=new manual;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"]; $gmanual=new gmanual; $money=new toMoney; $cat=new catalogue;
	...
	if ($n==1){ 
		...
		$form="";
		if ($doc_type_id==61) $form_htm=RD."/tpl/back_clients_print_n1.htm"; //���
		if ($doc_type_id==63) $form_htm=RD."/tpl/back_clients_print_n2.htm"; //��
		if ($doc_type_id==64) $form_htm=RD."/tpl/back_clients_print_n3.htm"; //��
...
function loadBackClientsPartition($back_id) {$db=DbSingleton::getDb(); $cat=new catalogue; $income=new income;
