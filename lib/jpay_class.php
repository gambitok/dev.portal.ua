...
//		if ($parrent_doc_type_id==63){ $parent_doc_name="�� �".$this->getSaleInvoiceName($parrent_doc_id); }
		$parent_doc_name="�� �".$this->getSaleInvoiceName($parrent_doc_id);
		if ($parrent_doc_type_id==98){ $parent_doc_name="�� �$doc_nom"; }
...
function getJpayClientContoCash($client_id){$db=DbSingleton::getDb();$cash_id=1;$answer=0;$err="�������";
...
function getJpayClientDocType($client_id){$db=DbSingleton::getDb();$doc_type_id=64;$answer=0;$err="�������";
...
function unlinkJpayClient($pay_id){$db=DbSingleton::getDb();$slave=new slave;$answer=0;$err="������� ���������� �����!";
...
function saveJpayMoneyPay($invoice_id,$kredit,$pay_type_id,$paybox_id,$doc_cash_id,$cash_id,$cash_kours){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function saveJpayMoneyBackPay($client_id,$avans_debit,$pay_type_id,$paybox_id,$cash_id,$cash_kours,$doc_cash_id){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function getJpayClientDocCashId($sel_id){$db=DbSingleton::getDb();$cash_name="������";$cash_id=1;
...
function saveJpayAutoMoneyPay($client_id,$kredit_gbl,$pay_type_id,$paybox_id,$cash_id,$cash_kours,$doc_cash_id){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function saveJpayAvansPay($client_id,$kredit_gbl,$pay_type_id,$paybox_id,$cash_id,$cash_kours,$doc_cash_id){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
	$client_id=$slave->qq($client_id);$kredit_gbl=$slave->qq($kredit_gbl);$cash_id=$slave->qq($cash_id);$cash_kours=$slave->qq($cash_kours);$doc_cash_id=$slave->qq($doc_cash_id);
	if ($client_id==0 || $client_id==""){
		$err="�� ������� �볺��� ��� ������";$answer=0;
	}
...
function saveJpayAvansMoneyPay($client_id,$kredit_gbl,$pay_type_id,$doc_cash_id){$db=DbSingleton::getDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
