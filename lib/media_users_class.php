...
class media_users {
	...
	function getRemIpInfo($remip){if ($remip==""){$remip=$_SERVER['REMOTE_ADDR'];}
	    ...
	    $ipLite = new ip2location_lite;$ipLite->setKey('1808a9ddbb5c3a08c12a717420076856d945709245cb8a542b8e012970f0936c');
	...
	function checkMediaUserLogout($user_id){ $db=DbSingleton::getDb();$logout=0;
	...
	function check_cookie_user(){session_start(); $db=DbSingleton::getDb(); $media_user_id=0;
	...
	function showMediaUserInfo($media_user_id){session_start();
