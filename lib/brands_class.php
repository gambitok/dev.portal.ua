...
function ImportBrands() {
    ...
    $form = str_replace(array("{records_list}", "{import_file_name}", "{csv_str_file}"), array("<tr><td colspan=10 align='center'>Записи не завантажено</td></tr>", "Оберіть файл", $pre_table), $form);
