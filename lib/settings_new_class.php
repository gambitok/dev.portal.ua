...
class SettingsNewClass {
	...
	function saveContacts($contact_id,$title,$address,$schedule,$phone){ $db=DbSingleton::getTokoDb(); $answer=0;$err="������� ���������� �����!";
		if ($contact_id>0){
	...
	function dropContacts($contact_id) { $db=DbSingleton::getTokoDb(); $answer=0;$err="������� ���������� �����!";
		if ($contact_id>0) {
	...
	function saveLanguage($lang_id,$lang_var,$lang_ru,$lang_ua,$lang_eng){ $db=DbSingleton::getTokoDb(); $answer=0; $err="������� ���������� �����!";										  
		if ($lang_id>0){
	...
	function dropLanguage($lang_id) { $db=DbSingleton::getTokoDb(); $answer=0; $err="������� ���������� �����!";
		if ($lang_id>0) {
	...
	function saveContactsBot($contact_id,$text,$icon,$link,$status){ $db=DbSingleton::getTokoDb(); $answer=0;$err="������� ���������� �����!";
		if ($contact_id>0){
	...
	function dropContactsBot($contact_id) { $db=DbSingleton::getTokoDb(); $answer=0;$err="������� ���������� �����!";
		if ($contact_id>0) {
	...
	function saveNews($news_id,$caption,$data,$short,$descr,$status){ $db=DbSingleton::getTokoDb(); $answer=0;$err="������� ���������� �����!";
		if ($news_id>0){
	...
	function dropNews($news_id) { $db=DbSingleton::getTokoDb(); $answer=0;$err="������� ���������� �����!";
		if ($news_id>0) {
