...
class alerts {
	...
	function list_alerts_navigation(){$db=DbSingleton::getDb();$slave=new slave;$mdl=new module;$url=$mdl->get_file_url("alerts");session_start(); $media_org_id=$_SESSION["media_org_id"];$media_user_id=$_SESSION["media_user_id"];
