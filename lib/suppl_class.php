...
function saveSupplGeneralInfo($suppl_id,$name,$full_name,$address,$chief,$country_id,$state_id,$region_id,$city_id){$db=DbSingleton::getDb();$dbt=DbSingleton::getTokoDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function saveSupplVat($suppl_id,$price_in_vat,$show_in_vat,$price_add_vat){$db=DbSingleton::getDb();$slave=new slave;session_start();$media_user_id=$_SESSION["media_user_id"];$media_user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function saveSupplOrderInfo($suppl_id,$info){$db=DbSingleton::getDb();$slave=new slave;session_start();$media_user_id=$_SESSION["media_user_id"];$media_user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";
...
function showCsvPreviewIndex($suppl_id){$db=DbSingleton::getDb();$slave=new slave; $csv_exist=0;$csv_file_name="������ ����";$pre_table="<h3 align='center'>������ ������</h3>";
...
//							print(." | ");
				...
				if ($records_list!=""){
					for ($i=1;$i<=$kol_cols;$i++){
						$cols_list.="<th><select id=\"clm-$i\" style='width:auto;' size='1'><option value='0'>-</option><option value='1'>������</option><option value='2'>�����</option><option value='3'>ART_ID</option><option value='4'>�� ��� ����������</option><option value='5'>����� ������</option></select></th>";
					}
				}
			}
			if ($file_type=="xls"){
				...
				for ($i=1;$i<=$rows;$i++){ $row="";
					for ($j=1;$j<=$kol_cols;$j++){
						if ($i==1){$cols_list.="<th><select id=\"clm-$j\" style='width:auto;' size='1'><option value='0'>-</option><option value='1'>������</option><option value='2'>�����</option><option value='4'>�� ��� ����������</option><option value='5'>����� ������</option></select></th>";}
						if ($j==1){$row="<td>$i</td>";}
					...
					while (($buffer = fgets($handle, 4096)) !== false) {$fn+=1;
						...
						if ($buffer!=""){
							...
							for ($i=1;$i<=$kol_cols;$i++){
								...
								if ($ex_cols==1){
									$cols_list.="<th><select id=\"clm-$i\" size='1'><option value='0'>-</option><option value='1'>������</option><option value='2'>�����</option><option value='3'>ART_ID</option><option value='4'>�� ��� ����������</option><option value='5'>����� ������</option></select></th>";
								}
							}if ($row!=""){
								$records_list.="<tr>$row</tr>";
							}
...
function finishSupplIndexImport($suppl_id,$start_row,$kol_cols,$cols){$db=DbSingleton::getDb();$dbt=DbSingleton::getTokoDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";require_once RD."/lib/clients_class.php"; $clients=new clients;
...
function showCsvPreviewPrice($suppl_id){$db=DbSingleton::getDb();$slave=new slave; $csv_exist=0;$csv_file_name="������ ����";$pre_table="<h3 align='center'>������ ������</h3>";
...
//							print(." | ");
				...
				if ($records_list!=""){
					...
					for ($i=1;$i<=$kol_cols;$i++){
						$cols_list.="<th><select id=\"clm-$i\" style='width:auto;' size='1'><option value='0'>-</option><option value='1'>������</option><option value='2'>�����</option><option value='3'>ֳ��</option><option value='4'>������</option>$storage_list</select></th>";
					}
				}
			}
			if ($file_type=="xls"){
				...
				for ($i=1;$i<=$rows;$i++){ $row="";
					for ($j=1;$j<=$kol_cols;$j++){
						if ($i==1){$cols_list.="<th><select id=\"clm-$j\" style='width:auto;' size='1'><option value='0'>-</option><option value='1'>������</option><option value='2'>�����</option><option value='3'>ֳ��</option><option value='4'>������</option>$storage_list</select></th>";}
						if ($j==1){$row="<td>$i</td>";}
						$row.="<td>".trim($data->val($i,$j,$sheet))."</td>";
					}
					if ($row!=""){
						...
						if ($buffer!=""){
							...
							for ($i=1;$i<=$kol_cols;$i++){
								...
								if ($ex_cols==1){
									...
									$cols_list.="<th><select id=\"clm-$i\" size='1'><option value='0'>-</option><option value='1'>������</option><option value='2'>�����</option><option value='3'>ֳ��</option><option value='4'>������</option>$storage_list</select></th>";
								}
							}if ($row!=""){
								$records_list.="<tr>$row</tr>";
							}
...
function finishSupplPriceImport($suppl_id,$start_row,$kol_cols,$main_cash_id,$kours_usd,$kours_eur,$cols){$db=DbSingleton::getDb();$dbt=DbSingleton::getTokoDb();$slave=new slave;session_start();$user_id=$_SESSION["media_user_id"];$user_name=$_SESSION["user_name"];$answer=0;$err="������� ���������� �����!";require_once RD."/lib/clients_class.php"; $clients=new clients;
...
function saveSupplCoop($suppl_id,$company,$name,$phone,$email,$city_id,$comment,$status) { $db=DbSingleton::getDb(); $answer=0; $err="������� ���������� �����!";
	if ($suppl_id>0){
