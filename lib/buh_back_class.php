...
function setBackClientsClient($back_id,$client_id){$db=new db;$slave=new slave;$answer=0;$err="Помилка збереження даних!";
...
function acceptBackClients($back_id){$db=new db;$dbt=new dbt;$slave=new slave; $cat=new catalogue; session_start(); $user_id=$_SESSION["media_user_id"]; $user_name=$_SESSION["user_name"]; $answer=0;$err="Помилка обробки даних!";
	$back_id=$slave->qq($back_id);
	if ($back_id>0){
