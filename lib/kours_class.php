...
class kours{
    ...
    function newKoursCard(){$db=DbSingleton::getDb();session_start();$user_id=$_SESSION["media_user_id"];
    ...
    function showKoursCard($kours_id){$db=DbSingleton::getDb();
        $form="";$form_htm=RD."/tpl/kours_card.htm";if (file_exists("$form_htm")){ $form = file_get_contents($form_htm);}
    ...
    function saveKoursForm($kours_id,$kours_value,$cash_id){$db=DbSingleton::getDb();$slave=new slave;
