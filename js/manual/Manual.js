...
function showManual(key,fldVal,fldText) {
	let manValue = document.getElementById(fldVal).value;
	let manText = document.getElementById(fldText).value;
...
function AddManualValue(key){
	let newValue = document.getElementById("NewCaption").value;
